...
export const PageHeader = (props: PageHeaderProps) => {
  ...
  useEffect(() => {
    if (productStatus === "addLikesResolved") {
      ...
      dispatch(ProductService.fetchSingleProduct(likedProductId));
    }

    if (productStatus === "addToWishListResolved") {
      // displaySuccessNotification("Added to Wishlist");
      dispatch(ProductService.fetchSingleProduct(wishedProductId));
    ...
    if (productStatus === "approveProductResolved") {
      ...
      if (
        ...
        if (approvedProductId > 0) {
          dispatch(ProductService.fetchSingleProduct(approvedProductId));
        }
    ...
    if (productStatus === "rejectProductResolved") {
      displaySuccessNotification("Product has been marked cancelled.");
    }
        ...
        <div className="container">
          <div style={{ width: "100%" }}>
            <Offline>
              <Alert
                type="error"
                message="You might have gone offline, Check your internet connection."
                banner
                closable
              />
            </Offline>
          ...
          <nav className="navbar navbar-inverse">
            <div className="navbar-header">
              ...
              <a href={routes.HOME} className="navbar-brand brand-x">
                <img src={jd_ver} />
              </a>
            </div>
