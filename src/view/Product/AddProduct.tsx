        ...
        <div className="item-stage">
          ...
          >
            ...
            <h4 className="text-center">
              Upload image(s) and add relevant description for item you want to
              sell or barter
            </h4>
            <div className="row">
              ...
              <div className="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
                <h4 className="text-center headingPrimary">
                  ...
                  <small className="subHeading">
                    In this section you must fill some relevant information
                    about the item to complete the upload process
                  </small>
                </h4>
              </div>
            </div>
